                      ...
                      {currentPlanetMode && typeof currentPlanetMode === "object" ? (
                        <>
                          ...
                          <span className="flex text-[#6387b1] gap-[5px]">
                            Source: <span className="underline"><Link to={currentPlanetMode.source}><span className="flex justify-between items-center w-[70px]">Wikipedia <img src="./icon-source.svg" alt="source" className="w-[12px] h-[12px]" /></span></Link></span>
                          </span>
                        </>
                      ) : null}
                    </>
